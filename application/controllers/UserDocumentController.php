...
class UserDocumentController extends CI_Controller {
    ...
    public function index_get() {
        ...
        if ($data) {
            ...
            $this->response($users_documents, 200);
        }
    }
    ...
    public function index_post() { //posting atau create
        ...
        if ($data) { 
            ...
            $id = $this->UserDocument->insert($attributes);
    ...
    public function index_delete() {
        ...
        $data = VERIFY::verify_request();
        if ($data) {
            $delete = $this->UserDocument->delete($id);
...
/* End of file UserDocumentController.php */
/* Location: ./application/controllers/UserDocumentController.php */